...
BINARY_LINK_OBJS    += --sp  vertexApply_1.newVertexProp1:HBM[10]
BINARY_LINK_OBJS    += --sp  vertexApply_1.newVertexProp2:HBM[18]
BINARY_LINK_OBJS    += --sp  vertexApply_1.newVertexProp3:HBM[26]
BINARY_LINK_OBJS    += --sp  vertexApply_1.tmpVertexProp0:HBM[3]
BINARY_LINK_OBJS    += --sp  vertexApply_1.tmpVertexProp0:HBM[11]
BINARY_LINK_OBJS    += --sp  vertexApply_1.tmpVertexProp0:HBM[19]
BINARY_LINK_OBJS    += --sp  vertexApply_1.tmpVertexProp0:HBM[27]
